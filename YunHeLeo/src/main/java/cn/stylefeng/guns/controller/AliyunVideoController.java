...
import cn.stylefeng.guns.entity.AliyunVideoResult;
...
@CrossOrigin
@Api(value = "阿里云视频点播",description = "阿里云视频点播")
public class AliyunVideoController {

    //账号AccessKey信息请填写(必选)
    private static String access_key_id = "LTAI4Fcpmj437CLu3fYVD3gm";
    //账号AccessKey信息请填写(必选)
    private static String access_key_secret = "2YMddtFKJFSDOzegK2S3Q7sSsZxvMS";
    ...
    private final static Logger LOG = Logger.getLogger(AliyunVideoController.class.getName());

    @GetMapping("/aliyunVideo")
    @ApiOperation("阿里云视频点播 公共参数")
    public AliyunVideoResult aliyun(String FileName, String Title,
        ...
        TimeStamp=2017-10-10T12:02:54Z
        &Format=JSON&AccessKeyId=testAccessKeyId
        &Action=GetVideoPlayAuth
        &SignatureMethod=HMAC-SHA1
        &SignatureNonce=8f8a035d-6496-4268-afd4-67c22837e38d
        &Version=2017-03-21&SignatureVersion=1.0&VideoId=5aed81b74ba84920be578cdfe004af4b
         */
        String url = VOD_DOMAIN+"/?AccessKeyId="+access_key_id+
                "&Format=JSON&SignatureNonce="+generateRandom() +
                "&SignatureMethod=HMAC-SHA1&Version=2017-03-21" +
                "&Timestamp="+generateTimestamp()+"&SignatureVersion=1.0&FileName="+FileName+"&Title="+Title+
                "&Action="+Action+"&FileSize="+FileSize+"&Signature=";
        //String url2 = "GET&%2F&AccessKeyId%3DtestAccessKeyId&Action%3DGetVideoPlayAuth&Format%3DJSON&SignatureMethod%3DHMAC-SHA1&SignatureNonce%3D8f8a035d-6496-4268-afd4-67c22837e38d&SignatureVersion%3D1.0&Timestamp%3D2017-10-10T12%253A02%253A54Z&Version%3D2017-03-21&VideoId%3D5aed81b74ba84920be578cdfe004af4b";
        // 待签名字符串
//        String url2 = percentEncode(url);
//        System.out.println("url2:"+url2);
        System.out.println(generateTimestamp());
        String StringToSign = percentEncode(url);
        System.out.println("StringToSign:"+StringToSign);
        String Signature = hmacSHA1Signature(access_key_secret, StringToSign);
        System.out.println("Signature:"+Signature);
        String url3 = url+Signature;
        httpGet(URL);
        return new AliyunVideoResult(true, url3, publicParams);
    }
